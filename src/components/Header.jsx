      ...
      <div className="flex justify-between items-center">
       <div className="profile flex  gap-1">
         ...
         <div className="name-good">
            ...
            <h1 className='text-sm text-gray-400'>Good {timeOfDay}</h1>
         </div>
        </div>
      <div className="bell">
       ...
       <div className="balance flex flex-col my-6 gap-3">
         <p className='text-sm text-gray-400'>Total Balance:</p>
          <h1 className='text-lime-300 text-2xl'>$42,295.00 USD</h1>
          <p className='text-red-400 text-[8px]'>Account restricted, please contact your management</p>
       </div>
